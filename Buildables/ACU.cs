...
{
    public static class ACU
    {
        public static PrefabInfo Info { get; } =
            PrefabInfo.WithTechType(
                "ACUjellyshroom",
                "ACU (Jellyshroom)",
                "Alien Containment Unit with Jellyshroom biome.");
        ...
        public static IEnumerator ModifyPrefabAsync(GameObject obj)
        {
            ...
            FruitPlantClone fruitPlant = obj.transform.Find("model").gameObject.AddComponent<FruitPlantClone>();
            ...
            SkyApplier skyApplier = planterModel.GetComponent<SkyApplier>();
            if (skyApplier == null)
            {
                skyApplier = planterModel.AddComponent<SkyApplier>();
            }

            skyApplier.anchorSky = Skies.Auto;
            skyApplier.renderers = planterModel.GetComponentsInChildren<Renderer>(true);

            PrefabUtils.AddConstructable(obj, Info.TechType, constructableFlags, planterModel);

            DestroyIfPresent(obj.GetComponent<Planter>());
            DestroyIfPresent(obj.GetComponent<StorageContainer>());
            DestroyChildIfPresent(obj.transform, "slots");
            DestroyChildIfPresent(obj.transform, "slots_big");
            DestroyChildIfPresent(obj.transform, "StorageRoot");
            DestroyChildIfPresent(obj.transform, "grownPlants");
        ...
        public static void Register()
        {
            ...
            CloneTemplate cloneTemplate = new CloneTemplate(Info, "87f5d3e6-e00b-4cf3-be39-0a9c7e951b84");
            ...
            GadgetExtensions.SetUnlock(customPrefab, TechType.PlanterBox, 1);
        ...
        private static void DestroyIfPresent(UnityEngine.Object obj)
        {
            if (obj != null)
            {
