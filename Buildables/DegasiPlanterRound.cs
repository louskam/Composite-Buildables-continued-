    ...
    public static class DegasiPlanterRound
    {
        public static PrefabInfo Info { get; } =
            PrefabInfo.WithTechType(
                    "DegasiPlanterRound",
                    "Degasi Planter (Round)",
                    "Bart Torgal's planter from Degasi Base 1-a.")
                .WithIcon(IconHelper.LoadIconOrFallback("DegasiPlanterRound.png", TechType.PlanterBox));
        ...
        public static IEnumerator ModifyPrefabAsync(GameObject obj)
        {
            ...
            planterModel.transform.Find("Base_interior_Planter_Pot_02").localScale = new Vector3(3f, 3f, 1f);
            planterModel.transform.Rotate(new Vector3(0f, 180f, 0f), Space.World);

            BoxCollider box = obj.transform.Find("Collider").GetComponent<BoxCollider>();
            Vector3 size = box.size;
            size.x *= 3f;
            size.z *= 3f;
            box.size = size;

            ConstructableBounds cb = obj.GetComponent<ConstructableBounds>();
            size = cb.bounds.size;
            size.x *= 3f;
            size.z *= 3f;
            cb.bounds.size = size;
            ...
            model.localPosition = new Vector3(0.185f, 0.3757f, -0.9f);
            ...
            model.Rotate(new Vector3(0f, 180f, 0f), Space.World);
            model.localPosition = new Vector3(0.309f, 0.2757f, 0.611f);
            ...
            model.Rotate(new Vector3(0f, 180f, 0f), Space.World);
            model.localPosition = new Vector3(0.053f, 0.2757f, -0.009f);
            ...
            model.localPosition = new Vector3(0.8f, 0.2805f, 0.427f);
            model.Rotate(new Vector3(0f, 180f, 0f), Space.World);

            model = PrefabFactory.AttachModelFromPrefabTo("28c73640-a713-424a-91c6-2f5d4672aaea", planterModel.transform);
            model.localScale = new Vector3(0.4366f, 0.4366f, 0.4366f);
            model.localPosition = new Vector3(0.578f, 0.3757f, -0.628f);
            model.Rotate(new Vector3(0f, 180f, 0f), Space.World);
            model.GetComponent<Renderer>().material.SetColor("_Scale", new Color(0f, 0f, 0f, 0f));
            ...
            model.localPosition = new Vector3(-0.378f, 0.2805f, -0.7f);
            model.Rotate(new Vector3(0f, 180f, 0f), Space.World);
            model.GetComponent<Renderer>().material.SetColor("_Scale", new Color(0f, 0f, 0f, 0f));
            ...
            model.localPosition = new Vector3(0.6871f, 0.371f, -0.05f);
            model.Rotate(new Vector3(0f, 180f, 0f), Space.World);
            model.GetComponent<Renderer>().material.SetColor("_Scale", new Color(0f, 0f, 0f, 0f));
            ...
            SceneHelper.DestroyChildIfPresent(obj.transform, "StoragetRoot");
            SceneHelper.DestroyChildIfPresent(obj.transform, "grownPlants");
            SceneHelper.DestroyChildIfPresent(obj.transform, "grownPlant");
        ...
        public static void UpdateRecipe()
        {
            ...
            CraftDataHandler.SetRecipeData(
                Info.TechType,
                RecipeJsonHelper.GetRecipe(nameof(DegasiPlanterRound), Plugin.config.RecipeComplexity));
        }
